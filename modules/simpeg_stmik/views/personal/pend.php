    ...
    <div id="apDiv1">
      <div id="apDiv2">
        <div id="TabbedPanels1" class="TabbedPanels">
          <ul class="TabbedPanelsTabGroup">
           <li class="TabbedPanelsTab" tabindex="0">Pendidikan</li>
          </ul>
          <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent"><iframe id="myframe" frameborder="0" src="<?= base_url (); ?>./simpeg_stmik/personal/pend/<?= $id ?>" height="950" width="800"></iframe></div>
          </div>
        </div>
      </div>
      <div id="cssmenu">
      ...
      <div id="cssmenu">
        <ul>
          ...
          <li class="active"><a href='<?= base_url(); ?>simpeg_stmik/personal/view_pend/<?= $id; ?>'><span>Pendidikan</span></a></li>
