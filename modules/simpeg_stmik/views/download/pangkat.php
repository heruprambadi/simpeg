...
<div id="container">
  ...
  <table border="0">
    <tr>
      <?php foreach ($pangkat_pilih as $p): ?>
      <th align="left" valign="bottom" colspan="4"><h3>Laporan Pegawai Berdasarkan Pangkat <?=$p->nama_mas_pangkat?></h3></th>
      <?php endforeach ?>
    </tr>
    <tr>
