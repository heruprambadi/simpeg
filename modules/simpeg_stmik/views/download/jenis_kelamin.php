...
$filename ="lap_jenis_kelamin-".$date.".xls";
...
<div id="container">
  ...
  <table border="0">
    <tr>
      <?php
      if($id == 1){
        echo '<th align="left" valign="bottom" colspan="4"><h3>Laporan Pegawai Berdasarkan Jenis Kelamin Pria</h3></th>';
      }elseif($id == 0){
        echo '<th align="left" valign="bottom" colspan="4"><h3>Laporan Pegawai Berdasarkan Jenis Kelamin Wanita</h3></th>';
      }else{
        echo '<th align="left" valign="bottom" colspan="4"><h3>Laporan Pegawai Berdasarkan Jenis Kelamin</h3></th>';
      }
      ?>
    </tr>
    <tr>
